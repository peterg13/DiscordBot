...
var pingTriggers = ['ping'];
var triggers = [pingTriggers];
...
var pingCommand = {
    ...
    command: function(msg){
        //will only execute if the message is just 'ping'
...
var commands = [pingCommand];


//all the functions in the export brackets will be available to use in our main file
module.exports = {

    checkTriggers: function(message){
        //the text from the message converted to Lower Case
        var msg = message.content.toLowerCase();
        for(i = 0; i < commands.length; i++){
            commands[i].triggers.forEach(function(trigger){
